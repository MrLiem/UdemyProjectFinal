...
const User = props => {
  ...
  return (
    <div>
      ...
      {/* Page Container */}
      <div className="w3-content w3-margin-top mt-5" style={{ maxWidth: 1400 }}>
        {/* The Grid */}
          ...
          <div className="w3-third">
            <div className="w3-white w3-text-grey w3-card-4">
              <div className="w3-display-container mb-3">
                <img
                  src="https://live.staticflickr.com/4331/36227702851_40b3936ec2_z.jpg"
                  style={{ width: "100%" }}
                  alt="Avatar"
                />
      ...
      <footer className="w3-container w3-teal w3-center w3-margin-top">
        ...
        <p>Powered by MrLiemComporation</p>
      </footer>
    </div>
  );
};
